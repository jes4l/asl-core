...
buttonList = [
    ...
    { text: "Ingredients Game", description: "You must sign the letters of the ingredients for a pizza to create it within a time frame. You will be given the ASL Sign to mimic.\n Tests your ability to sign ASL correctly and accurately.", room: rmPizzaGameStart, dashStartX: 100, dashEndX: 1510, dashY: 380, numOfActiveWords: 3, sprite: sPizzaGameMenuSprite },
