if (!variable_instance_exists(id, "perf")) {
    perf = scrCalculatePerformance();
}

var lettersToDisplay = (showWorst) ? perf.worst : perf.best;
var count = array_length_1d(lettersToDisplay);
...
if (showWorst) {
    draw_text(251, 340, "Target Letters:");
} else {
    draw_text(251, 340, "Best Performed Letters:");
}
